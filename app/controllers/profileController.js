app.controller("ProfileController", [
  ...
  function ($scope, $http) {
    $scope.uploadResume = function () {
      ...
      $http
        .post(`${$scope.baseUrl}/users/upload-resume`, formData, {
          headers: {
    ...
    $scope.fetchAppliedJobs = function () {
      ...
      $http
        .get(`${$scope.baseUrl}/users/applications`, {
          headers: {
            Authorization: `Bearer ${token}`,
          },
        })
    ...
    $scope.fetchsavedJobs = function () {
      ...
      $http
        .get(`${$scope.baseUrl}/users/getAllsavedjobs`, {
          headers: {
            Authorization: `Bearer ${token}`,
          },
        })
